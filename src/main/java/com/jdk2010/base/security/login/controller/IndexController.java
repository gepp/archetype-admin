...
public class IndexController extends BaseController {
	...
	public void getMenu(HttpServletRequest request, HttpServletResponse response)
		...
		Map<Object, Object> userMenuMap = securityUserService
				.getUserMenu(securityUser);
		for (Object obj : userMenuMap.keySet()) {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				menuStr = menuStr + "<li><cite></cite><a href=\"" + contextpath
						+ "" + secondMap.get("url")
						+ "\" target=\"rightFrame\">" + secondMap.get("name")
						+ "</a><i></i></li>";
			}
	...
	public String defaultMain(HttpServletRequest request,
	...
	@RequestMapping("/tech")
	public String tech(HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		return "/tech";
	}
